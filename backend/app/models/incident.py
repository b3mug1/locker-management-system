...
class LockerIncident(Base):
    ...
    assigned_technician_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
    ...
    assigned_technician = relationship("User", foreign_keys=[assigned_technician_id], lazy="selectin")
